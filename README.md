...
### 현재 범위
- `Daily Deals` (1 row = 1 product exposure)
- `Store Daily Summary` (1 row = 1 `store_id x date`)
- `Products`
- `Runs`

> `Daily Deals`는 raw drill-down용, `Store Daily Summary`는 스토어 점유율/운영 패턴 확인용으로 사용합니다.
